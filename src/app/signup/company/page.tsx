        ...
        <div className="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">
              {step === 1 ? "서비스 이용을 위한 약관에 동의해주세요." : "기업 정보를 입력해주세요."}
            </p>
          </div>
        </div>
        ...
        {step === 1 ? (
          ...
          <form className="space-y-6">
            ...
            <div className="pt-6 flex gap-3">
              ...
              <button type="submit" className="w-2/3 bg-gray-800 text-white font-bold py-3 rounded-lg hover:bg-gray-700 transition-colors">
                기업회원 가입완료
              </button>
            </div>
          </form>
